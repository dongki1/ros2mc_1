...
const DebugVectRefStruct = StructType({
...
const DebugVectRefArray = ArrayType(DebugVectRefStruct);
const DebugVectRefStructArray = StructType({
  data: DebugVectRefArray,
  size: ref.types.size_t,
  capacity: ref.types.size_t
});
// Define the wrapper class.
class DebugVectWrapper {
  constructor(other, willCheckConsistency = false) {
    this._wrapperFields = {};
    this._willCheckConsistency = willCheckConsistency;
    if (typeof other === 'object' && other._refObject) {
      this._refObject = new DebugVectRefStruct(other._refObject.toObject());
  ...
  _initMembers() {
    this._refObject = new DebugVectRefStruct();
  ...
  static createFromRefObject(refObject) {
    let self = new DebugVectWrapper();
    self.copyRefObject(refObject);
    return self;
  }
  static createArray() {
    return new DebugVectArrayWrapper;
  }
  static get ArrayType() {
    return DebugVectArrayWrapper;
  }
  static get refObjectArrayType() {
    return DebugVectRefStructArray
  }
  static get refObjectType() {
    return DebugVectRefStruct;
  }
  toRawROS() {
    this.freeze(true);
  ...
  freeze(own = false, checkConsistency = false) {
      if (checkConsistency && !this._timestampIntialized) {
        throw new TypeError('Invalid argument: timestamp in DebugVect');
      }
      if (checkConsistency && !this._xIntialized) {
        throw new TypeError('Invalid argument: x in DebugVect');
      }
      if (checkConsistency && !this._yIntialized) {
        throw new TypeError('Invalid argument: y in DebugVect');
      }
      if (checkConsistency && !this._zIntialized) {
        throw new TypeError('Invalid argument: z in DebugVect');
      }
  ...
  static destoryRawROS(msg) {
    DebugVectWrapper.freeStruct(msg.refObject);
  }
  static type() {
    return {pkgName: 'px4_msgs', subFolder: 'msg', interfaceName: 'DebugVect'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  copyRefObject(refObject) {
    this._refObject = new DebugVectRefStruct(refObject.toObject());
    this._timestampIntialized = true;
    this._wrapperFields.name.fill(refObject.name.toArray());
    this._xIntialized = true;
    this._yIntialized = true;
...
class DebugVectArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof DebugVectWrapper) {
        this._wrappers[index].copy(value);
      } else {
        this._wrappers[index] = new DebugVectWrapper(value);
      }
    });
  }
  ...
  set size(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to DebugVectArrayWrapper.size setter');
      return;
    }
  ...
  set capacity(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to DebugVectArrayWrapper.capacity setter');
    }
    return this._resize(value);
  }
  get refObject() {
  ...
  _resize(size) {
    ...
    this._refArray = new DebugVectRefArray(size);
    this._refObject = new DebugVectRefStructArray();
    this._refObject.size = size;
    this._refObject.capacity = size;
    this._wrappers = new Array();
    for (let i = 0; i < size; i++) {
      this._wrappers.push(new DebugVectWrapper());
    }
  }
  ...
  copy(other) {
    if (! (other instanceof DebugVectArrayWrapper)) {
      throw new TypeError('Invalid argument: should provide "DebugVectArrayWrapper".');
    }
  ...
  static freeArray(refObject) {
    ...
    for (let index = 0; index < refObject.size; index++) {
      DebugVectWrapper.freeStruct(refObjectArray[index]);
    }
  }
...
module.exports = DebugVectWrapper;
/*
