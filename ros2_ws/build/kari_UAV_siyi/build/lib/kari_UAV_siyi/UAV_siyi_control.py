...
_GET_GIMBAL_ATTITUTE_TOPIC =    "siyi/get_gimbal_attitude"
_GET_ZOOM_TOPIC =               "siyi/get_zoom_level"
_SET_GIMBAL_ATTITUDE_TOPIC =    "siyi/set_gimbal_attitude"
_SET_ZOOM_TOPIC =               "siyi/set_zoom_level"
_SET_FOCUS_TOPIC =              "siyi/set_focus"

_CONTROLLER_NODE_NAME =         "siyi_controller_node"
_GIMBAL_FRAME_ID =              "siyi_gimbal"

_SIYI_SERVER_IP =               "192.168.144.25"
_SIYI_SERVER_PORT =             37260
...
def main(args=None):
    camera = SIYISDK(server_ip=_SIYI_SERVER_IP, port=_SIYI_SERVER_PORT)
    camera.connect()
