...
#_CAM_STREAM_URI = "rtsp://192.168.0.66:1935/live"
_CAM_STREAM_URI = "rtsp://192.168.144.25:8554/main.264"
_CAM_NODE_NAME = "camera_node"
_CAM_PUB_TOPIC = "siyi/camera_stream"
_CAM_FRAME_ID = "siyi_stream"
#_QUEUE_SIZE = 10
_QUEUE_SIZE = 200
#_PUBLISH_PERIOD_SEC = 1.11
...
class CameraStreamNode(Node):
    def __init__(self, capture: cv2.VideoCapture, node_name: str =_CAM_NODE_NAME, pub_period: float=_PUBLISH_PERIOD_SEC) -> None:
        ...
        # self.publisher = self.create_publisher(Image, _CAM_PUB_TOPIC, qos_profile_sensor_data)
